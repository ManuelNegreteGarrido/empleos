...
class JobapplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create jobapplication" do
    assert_difference("Jobapplication.count") do
      post jobapplications_url, params: { jobapplication: { description: @jobapplication.description } }
    end
  ...
  test "should update jobapplication" do
    patch jobapplication_url(@jobapplication), params: { jobapplication: { description: @jobapplication.description } }
